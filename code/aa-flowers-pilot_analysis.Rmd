...
d.by_player_metrics %>%
  ...
  summarize(playerPoints = sum(playerUtility)) %>%
  ...
  stat_summary(fun.data = "mean_cl_boot", position=position_dodge(width=.5)) + scale_color_bay() + theme_jmank() + theme(legend.position = "bottom")
```
