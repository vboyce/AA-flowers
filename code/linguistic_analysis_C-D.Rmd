...
d_flowers <- d %>% 
  filter(type=="message") %>%
  filter(!is.na(text))
#write_csv(d, "~/Downloads/raw_chat2.csv")
...
ggplot(d_flowers_utt_length_block, aes(x=blockNum, y=total_num_words))+
...
ggplot(d_flowers_utt_length_block, aes(x=blockNum, y=mlu))+
  facet_grid( rows =vars(condition)) +
  geom_jitter(alpha=.05)+
  geom_smooth(method=glm, formula=y~poly(x,2), alpha=.3)+
  stat_summary(fun.data = "mean_cl_boot")+
...
ggplot(d_flowers_utt_length_trial, aes(x=trialNum, y=total_num_words))+
  facet_grid(rows =vars(condition)) +
  geom_point()+
  geom_jitter(alpha=.05)+
  geom_smooth(method=glm, formula=y~poly(x,2), alpha=.3)+
...
ggplot(d_flowers_utt_length_trial, aes(x=trialNum, y=mlu))+
  facet_grid( rows =vars(condition)) +
  geom_jitter(alpha=.05)+
  geom_smooth(method=glm, formula=y~poly(x,2), alpha=.3)+
  stat_summary(fun.data = "mean_cl_boot")+
...
ggplot(d_flowers_utt_length_rep, aes(x=repNum, y=total_num_words))+
  facet_grid(rows =vars(condition)) +
  geom_point()+
  geom_jitter(alpha=.05)+
  geom_smooth(method=glm, formula=y~poly(x,2), alpha=.3)+
...
ggplot(d_flowers_utt_length_rep, aes(x=repNum, y=mlu))+
  facet_grid( rows =vars(condition)) +
  geom_jitter(alpha=.05)+
  geom_smooth(method=glm, formula=y~poly(x,2), alpha=.3)+
  stat_summary(fun.data = "mean_cl_boot")+
...
ggplot(d_flowers_n_turns_rep, aes(x=repNum, y=n))+
  facet_grid(rows =vars(condition)) +
  geom_jitter(alpha=.05)+
  geom_smooth(method=glm, formula=y~poly(x,2), alpha=.3)+
  stat_summary(fun.data = "mean_cl_boot")+
...
ggplot(d_flowers_n_turns_trial, aes(x=trialNum, y=n))+
  facet_grid(rows =vars(condition)) +
  geom_jitter(alpha=.05)+
  geom_smooth(method=glm, formula=y~poly(x,2), alpha=.3)+
  stat_summary(fun.data = "mean_cl_boot")+
...
ggplot(d_flowers_n_turns_block, aes(x=blockNum, y=n))+
  facet_grid(rows =vars(condition)) +
  geom_jitter(alpha=.05)+
  geom_smooth(method=glm, formula=y~poly(x,2), alpha=.3)+
  stat_summary(fun.data = "mean_cl_boot")+
...
ggplot(d_flowers_n_utt_speaker, 
       aes(x=trialNum, y=n_utt_speaker)) + 
...
ggplot(d_flowers_n_utt_speaker, 
       aes(x=blockNum, y=n_utt_speaker)) + 
  geom_smooth(method = "lm", formula = y~x) + 
  geom_point(alpha=.1) +
  facet_grid(~condition) +
  xlab("Block number") + 
...
ggplot(d_flowers_pos, 
       aes(x=blockNum, y=prop_pos, label=gameId)) + 
  geom_smooth(method = "lm", formula = y~x) + 
  geom_point(alpha=.1) +
  facet_grid(rows =vars(condition), cols=vars(pos)) +
  xlab("Block number") + 
...
ggplot(d_flowers_pos, 
       aes(x=trialNum, y=prop_pos, label=gameId)) + 
  geom_smooth(method = "lm", formula = y~x) + 
  geom_point(alpha=.1) +
  facet_grid(rows =vars(condition), cols=vars(pos)) +
  xlab("Trial number") + 
...
ggplot(d_flowers_pos, 
       aes(x=repNum, y=prop_pos, label=gameId)) + 
  geom_smooth(method = "lm", formula = y~x) + 
  geom_point(alpha=.1) +
  facet_grid(rows =vars(condition), cols=vars(pos)) +
  xlab("Rep number") + 
...
ggplot(d_flowers_n_utt_dist, 
       aes(x=blockNum, y=overall_turns, label=playerId)) + 
  geom_smooth(method = "lm", formula = y~x) + 
  geom_point(alpha=.1) +
  facet_wrap(~condition)+
  xlab("Block number") + 
...
ggplot(d_flowers_q, 
       aes(x=trialNum, y=prop_questions, label=gameId)) + 
  geom_smooth(method = "lm", formula = y~x) + 
  facet_wrap(~ condition) +
  geom_point(alpha=.5) +
  xlab("Trial number") + 
...
ggplot(d_flowers_q, 
       aes(x=repNum, y=prop_questions, label=gameId)) + 
  geom_smooth(method = "lm", formula = y~x) + 
  facet_wrap(~ condition) +
  geom_point(alpha=.5) +
  xlab("Rep number") + 
...
ggplot(d_flowers_q, 
       aes(x=blockNum, y=prop_questions, label=gameId)) + 
  geom_smooth(method = "lm", formula = y~x) + 
  facet_wrap(~ condition) +
  geom_point(alpha=.5) +
  xlab("Block number") + 
...
ggplot(d_flowers_feedback, aes(y=prop_backchannel_words , x=trialNum, label=gameId)) +
  facet_wrap(~ condition) +
  geom_point(alpha = .5)+
  geom_smooth()+
  xlab("Trial number") + 
...
ggplot(d_flowers_feedback, aes(y=prop_hedge_words , x=trialNum, label=gameId)) +
  facet_wrap(~ condition) +
  geom_point(alpha = .5)+
  geom_smooth()+
  xlab("Trial number") + 
...
ggplot(d_flowers_feedback, aes(y=prop_backchannel_words , x=blockNum, label=gameId)) +
  facet_wrap(~ condition) +
  geom_point(alpha = .5)+
  geom_smooth()+
  xlab("Block number") + 
...
ggplot(d_flowers_feedback, aes(y=prop_hedge_words , x=blockNum, label=gameId)) +
  facet_wrap(~ condition) +
  geom_point(alpha = .5)+
  geom_smooth()+
  xlab("Block number") + 
...
ggplot(d_flowers_feedback, aes(y=prop_backchannel_words , x=repNum, label=gameId)) +
  facet_wrap(~ condition) +
  geom_point(alpha = .5)+
  geom_smooth()+
  xlab("Rep number") + 
...
ggplot(d_flowers_feedback, aes(y=prop_hedge_words , x=repNum, label=gameId)) +
  facet_wrap(~ condition) +
  geom_point(alpha = .5)+
  geom_smooth()+
  xlab("Rep number") + 
