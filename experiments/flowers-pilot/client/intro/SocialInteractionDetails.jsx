        ...
        <div className="instructions">
          ...
          <div class="interface-instructions">
            <div class="instruction-example">
              <div className="instruction-image"> <img src="/experiment/tutorial_images/interface_temp.png" ALIGN="left"/>
              </div>
              <hr />
            ...
            <div className="instruction-example">
              ...
              <hr />
              <p>Your total score is the amount of money you've earned so far. You will be paid this amount as a bonus at the end of the game. Keep an eye on it! </p>
            </div>
            ...
            <div className="instruction-example">
              ...
              <hr />
              {coopCartelBool && <p>The bars above the flowers represent how much each flower is worth on the market. The longer the bar, the more the flower is expected to sell. Remember, if all {treatment.playerCount} of you select the same flower, you will recieve a {treatment.playerCount}x bonus. </p>}

              {competCartelBool && <p>The bars above the flowers represent how much each flower is worth on the market. The longer the bar, the more the flower is expected to sell. Remember, if all {treatment.playerCount} of you select the same flower, you will recieve a 1/{treatment.playerCount}x penalty. </p>}
            </div>

            <div className="instruction-example">
              <div className="instruction-image">
              {coopCartelBool && <img src="/experiment/tutorial_images/interface_temp.png" ALIGN="left"/>}
              {competCartelBool && <img src="/experiment/tutorial_images/interface_temp.png" ALIGN="left"/>}
              </div>
              <hr />
